...
export const metadata: Metadata = {
  title: "Bayka Coffeeshop - Experience the Essence of Coffee",  description: "Savor expertly crafted coffees and delightful treats at Bayka, a cozy coffeeshop dedicated to quality and community.",  openGraph: {
    title: "Bayka Coffeeshop",    description: "Savor expertly crafted coffees and delightful treats at Bayka, a cozy coffeeshop dedicated to quality and community.",    url: "/",    siteName: "Bayka Coffeeshop",    images: [
      {
        url: "https://img.b2bpic.net/free-photo/woman-grinding-coffee-coffee-machine_1303-31284.jpg",        alt: "Freshly roasted coffee beans"},
    ],
    type: "website"},
  twitter: {
    card: "summary_large_image",    title: "Bayka Coffeeshop - Experience the Essence of Coffee",    description: "Savor expertly crafted coffees and delightful treats at Bayka, a cozy coffeeshop dedicated to quality and community.",    images: ["https://img.b2bpic.net/free-photo/woman-grinding-coffee-coffee-machine_1303-31284.jpg"],
  },
  robots: {
    index: true,
    follow: true,
